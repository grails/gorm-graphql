...
----
include::examples/grails-docs-app/grails-app/domain/demo/Speaker.groovy[tags=wholeFile]
----
...
----
include::examples/grails-docs-app/grails-app/domain/demo/Talk.groovy[tags=wholeFile]
----
