...
include::examples/grails-docs-app/grails-app/domain/demo/Author.groovy[tags=associationDefinition]
...
include::examples/grails-docs-app/grails-app/domain/demo/Author.groovy[tags=customBooks]
...
----
include::examples/grails-docs-app/src/main/groovy/demo/AuthorDataBinder.groovy[tags=wholeFile]
----
...
include::examples/grails-docs-app/grails-app/domain/demo/Author.groovy[tags=locationDefinition]

    static graphql = GraphQLMapping.build {

include::examples/grails-docs-app/grails-app/domain/demo/Author.groovy[tags=customLocation]
...
----
include::examples/grails-docs-app/src/integration-test/groovy/demo/AuthorIntegrationSpec.groovy[tags=createCommand]
----
...
[source, json]
----
include::examples/grails-docs-app/src/integration-test/groovy/demo/AuthorIntegrationSpec.groovy[tags=createResponse]
----
