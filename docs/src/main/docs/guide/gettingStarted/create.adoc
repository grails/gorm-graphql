...
----
include::examples/grails-docs-app/src/integration-test/groovy/demo/CreateSpeakerIntegrationSpec.groovy[tags=curlCommand]
----
...
[source, json]
----
include::examples/grails-docs-app/src/integration-test/groovy/demo/CreateSpeakerIntegrationSpec.groovy[tags=response]
----
